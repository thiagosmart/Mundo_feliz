  ...
  def create
    ...
    respond_to do |format|
      if @tipo_produto.save
        format.html { redirect_to tipo_produto_url(@tipo_produto), notice: "Tipo produto was successfully created." }
  ...
  def update
    respond_to do |format|
      if @tipo_produto.update(tipo_produto_params)
        format.html { redirect_to tipo_produto_url(@tipo_produto), notice: "Tipo produto was successfully updated." }
